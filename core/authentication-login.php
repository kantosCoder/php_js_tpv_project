        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-dark">
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    ...
                    <form class="form-horizontal m-t-20" id="loginform" action="engine/processing/loginvalidation.php" method="POST">
                        ...
                        <div class="row border-top border-secondary">
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
										<a href="index.php"><button class="btn btn-info" type="button"><i class="far fa-arrow-alt-circle-left m-r-5"></i> Volver al panel</button></a><a href="authentication-login-box.php">&ensp;<button class="btn btn-warning" type="button"><i class="fas fa-tablet-alt"></i><b>Cambiar a TPV</b></button></a>
