            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h2 class="page-title"><h2>&ensp;<i class="fas fa-edit"></i></i><i class="fas fa-users"></i> &ensp;Modificación de cliente</h2>
                    </div>
                </div>
            </div>
		<div class="col-md-6">
			<marquee><h4>
			Estás modificando el cliente llamado "'.$username.'." Todos los cambios realizados se verán reflejados en su campo.&ensp;&ensp;
			</h4>
			</marquee>
		</div>
		 ...
		 <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            <form class="form-horizontal" action="engine/processing/clientupdate.php?mod='.$id.'" method="post">
                                <div class="card-body">
                                    <h4 class="card-title">Datos del cliente "'.$username.'" &ensp;&ensp;</h4></br>
                                ...
                                <div class="border-top">
                                    <div class="card-body">
                                        <button class="btn btn-primary"><i class="fas fa-plus"></i>&ensp;Guardar cambios</button>
                                    </div>
                                </div>
